	...
	<div className="flex bg-white border-b border-grey-lighter fixed pin-t pin-x z-100 h-16 items-center">
		<div className="w-full max-w-screen-xl relative mx-auto px-6">
			<div className="flex items-center mx-6">
				<h1 className="lg:w-1/3 xl:w-1/5 px-6 lg:pr-8 text-3xl">
					Clara Ameller
				</h1>
				<div className="flex flex-grow items-center lg:w-2/3 xl:w-4/5">
					<h1 className="w-full text-center lg:px-6 lg:w-2/3 xl:px-12 text-3xl">User Roles</h1>
					<div className="hidden lg:block lg:w-1/3 px-6">
